...
Je maakt gebruik van automatisch ophogen, je tegoed wordt automatisch opgehoogd met {{ currency($invoice->user->mollie_amount) }}
...
Je maakt geen gebruik van automatisch ophogen, maar dat kan je hier instellen:
