                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            <li class="nav-item">
                                <a wire:click=setTab('profile') class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;"
                            ...
                            <li class="nav-item">
                                <a wire:click="setTab('tally')" class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab"
                            ...
                            <li class="nav-item">
                                <a wire:click="setTab('invoices')" class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="javascript:;" role="tab"
