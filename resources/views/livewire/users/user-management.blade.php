                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{$user->role_id}}</p>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{$user->last_login_at}}</span>
                                    </td>
                                    <td class="text-center">
                                        ...
                                        <a href="#" class="mx-3" data-bs-toggle="modal"
                                            data-bs-target="#user-update-{{$user->id}}"
                                        ...
                                        <span>
                                            <i class="cursor-pointer fas fa-trash text-secondary"
                                               ...
                                               data-bs-target="#user-delete-{{$user->id}}"
                                ...
                                @include('components.user-delete-modal')
                            @endforeach
                            </tbody>
                        </table>
                    </div>
